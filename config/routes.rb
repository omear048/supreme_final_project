Rails.application.routes.draw do
  ...
  match '/account_details/orders', to: 'account_details#orders', via: 'get', as: 'account_details_orders'
  ...
  match '/products/:product_id', to: 'products#show', via: 'get', as: 'show_item'
  match '/help',      to:'static_pages#help',      via: 'get'
  match '/account_details/sold', to:'account_details#sold', via: 'get', as: 'sold'
end
